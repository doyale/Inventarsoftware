...
def newEntry():
    ...
    pubchem_fetch_button = tk.Button(master=window, background=banner_bg, foreground=banner_fg, text=pubchem_btn_text, width=63, pady=10,
    ...
    id_entry_frame = tk.Frame(master=entry_frame)
    id_entry = tk.Entry(master=id_entry_frame, background=info_bg, font=info_entry_font, width=int(entry_width/2))
    new_id_button = tk.Button(master=id_entry_frame, background=banner_bg, foreground=banner_fg, text=new_id_btn_text, width=19, pady=0,
                                  command=assignNewIDEvent)
    ...
    save_entry_button = tk.Button(master=window, background=banner_bg, foreground=banner_fg, text=edit_btn_text, width=63, pady=10,
